...
public class PaicoinJSONRPCClientTestA {

    class MyClientTest extends PaicoinJSONRPCClient {
    ...
    public void signRawTransactionTest() throws Exception {
        client = new MyClientTest(false, "signrawtransaction", null,
                                    "{\n" +
                                            ...
                                            "  \"complete\": true\n" +
                                            "}\n");
        LinkedList<PaicoindRpcClient.ExtendedTxInput> inputList = new LinkedList<PaicoindRpcClient.ExtendedTxInput>();
